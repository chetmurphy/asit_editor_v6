        ...
        "start": [
            {
                ...
                token: "string", //list.markup",
                regex: /^\s*[\-?](?:$|\s)/
            }, {
                token: "variable.class", //"string", //"constant",
                regex: "![\\w//]+[:]*"
            }, {            }, {
                token: "string", //"constant",
                regex: "!![\\w//]+"
            }, {
                token: "string", //"constant.language",
                regex: "[&\\*][a-zA-Z0-9-_]+"
            }, {
                ...
                token: "string", //"constant.numeric",
                regex: /(\b|[+\-\.])[\d_]+(?:(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)(?=[^\d-\w]|$)$/
            }, {
                token: "string", //"constant.numeric",
                regex: /[+\-]?\.inf\b|NaN\b|0x[\dA-Fa-f_]+|0b[10_]+/
            }, {
                token: "string", //"constant.language.boolean",
                regex: "\\b(?:True|False)\\b" // "\\b(?:true|false|TRUE|FALSE|True|False|yes|no)\\b"
            }, {
                token: "paren.lparen",
                regex: "[[({]"
            }, {
